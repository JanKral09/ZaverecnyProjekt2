...
The application is designed for intuitive and fast use. Here are the main features available to the user:
...
Under the hood, the application utilizes modern programming approaches and monitors user inputs:
